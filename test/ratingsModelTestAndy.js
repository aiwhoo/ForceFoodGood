...
describe('Restaurant Rating System (Andy Version)', function() {
    ...
    it('should throw an error if the input of stars are invalid (<0 or >5)', function() {
    ...
    it('should create a valid rating for this validation case of decimal stars', function() {
        const rating = new RatingModel(3.5, "Andy", "2026-3-3", "The food was very tasty");
        expect(rating.stars).to.equal(3.5);
    });
});